...
export const routes: MigrationRoute[] = [
  ...
  {
    id: "east-asia",
    name: "Northward Expansion into East Asia",
    startYear: -50000,
    endYear: -40000,
    color: "#5ba05b",
    waypoints: [
  ...
  {
    id: "north-asia",
    name: "Ancient North Siberians / ANE",
    startYear: -38000,
    endYear: -24000,
    color: "#7bb85b",
    waypoints: [
  ...
  },
  {
    ...
    name: "Eastward Expansion across North America",
    startYear: -14000,
    endYear: -8000,
    color: "#b85450",
    waypoints: [
  ...
  },
  {
    ...
    description:
      "An independent migration from northeast Siberia and Chukotka across Beringia roughly 5,000 years ago, genetically distinct from both the earlier First Peoples and the later Inuit. Bearers of the Arctic Small Tool tradition (Pre-Dorset, Saqqaq, Independence, and later Dorset cultures) spread through the High Arctic Archipelago and reached northeastern Greenland (Independence Fjord) before working southward to Disko Bay by ~4,500 years ago. They occupied the Arctic for some 4,000 years before being replaced by the expanding Thule ~700 years ago, leaving no living descendants.",
  },
  {
    id: "thule-inuit",
    name: "Thule (Inuit) Migration",
    startYear: 1000,
    endYear: 1300,
    color: "#3a7a9e",
    waypoints: [
    ...
    description:
      "The ancestors of today's Inuit, the Thule, developed from earlier Birnirk populations in the Bering Strait region of coastal Alaska and expanded eastward along the mainland Canadian Arctic coast beginning around 1000 CE, reaching northwestern Greenland (the Thule/Pituffik area) by ~1200-1300 CE.\nThe pace is striking: roughly 6,500 km of Arctic coastline crossed in just two to three centuries, one of the fastest large-scale human migrations on record and the reason the recent radiocarbon re-evaluation by Robert Park is titled \"A Culture in a Hurry?\"\nEquipped with dog sleds, kayaks, umiaks, and sophisticated marine-mammal hunting technology, the Thule replaced the earlier Paleo-Eskimo (Dorset) population across the entire Arctic, a separate and much earlier migration with no living descendants.",
  },
  {
    id: "austronesian",
  ...
  },
  {
    ...
    name: "Mesoamerican Maize Expansion",
    startYear: -7000,
    endYear: -4000,
    color: "#d4b94a",
  ...
  },
  {
    ...
    name: "Polynesian-Americas Contact",
    startYear: 1100,
    endYear: 1200,
    color: "#c060a0",
