...
export const events: MigrationEvent[] = [
  {
    ...
    year: -200000,
    location: [35.9, 5.4], // Omo Kibish, Ethiopia
    description:
  ...
  },
  {
    ...
    name: "Out of Africa",
    year: -65000,
    location: [45, 15], // Southern Arabia
  ...
  },
  {
    ...
    year: -50000,
    location: [132, -12], // Northern Australia
    routeId: "sahul",
    description:
  ...
  },
  {
    ...
    year: -15000,
    location: [-125, 48], // Pacific Northwest
    routeId: "americas",
    description:
